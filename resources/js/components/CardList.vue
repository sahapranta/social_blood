    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3 text-center request-card" v-for="blod in bloods">                        
            ...
            <div class="card-header">
                ...
                <small class="text-wrap"><i class="fa fa-map-marker"></i> dfddafafaf</small>
            </div>
            <div class="card-body">                
                <svg viewBox="0 0 54 60" width="80" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text transform="matrix(1 0 0 1.28 29 51)" font-weight="bolder" font-size="0.75em" fill="#000" text-align="center">B+</text>                                                
                </svg>
                <p class="text-wrap">ssdsd</p>                                
                <a href="blood_request/show" type="button" class="btn btn-lg btn-block btn-outline-danger shadow-sm mt-2">
